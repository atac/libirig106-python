...
class Time_DMY(ctypes.Structure):
    ...
    _fields_ = [("uTmn", ctypes.c_uint16, 4),  # Tens of milliseconds
                ...
                ("uHYn",            ctypes.c_uint16, 4),
                # Thousands of year number
                ("uOYn",            ctypes.c_uint16, 2),
...
def I106_Decode_TimeF1(header, msg_buffer):
    ...
    ret_status = Packet.IrigDataDll.enI106_Decode_TimeF1(ctypes.byref(
        header), ctypes.byref(msg_buffer), ctypes.byref(native_irig_time))
...
class DecodeTimeF1(object):
    ...
    def decode_time_f1(self):
        ret_status, self.irig_time = I106_Decode_TimeF1(
